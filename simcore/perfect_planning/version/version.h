...
#define FILE_VERSION_STR(branch, commit_id) \
  "V" Stringizing(branch) "." Stringizing(commit_id) "-" "20250403" "-" "034431"

// generate product version
#define PRODUCT_VERSION_STR(major, minor, build, revision) \
  "V" Stringizing(major) "." Stringizing(minor) "." Stringizing(build) "." Stringizing(revision) "-" "20250403" "T" "034431"
